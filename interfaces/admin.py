...
from customtkinter import CTkFrame, CTkButton, CTkLabel, CTkComboBox, CTkImage, CTkEntry

def Admin_Interface(app):
    admin_frame = CTkFrame(master=app.root, fg_color='#F3C892', bg_color='#F3C892', width=1300, height=700)
    ...
    CTkButton(master=title_frame, text='',
              image=CTkImage(light_image=Image.open('Images/Sign_Out.png'), size=(35, 35)), command=app.SignOut,
    ...
    CTkLabel(master=details_frame, text='ID', text_color='#954535', font=('Stack Sans Text', 13, 'bold')).place(
        x=15, y=45)
    ID = CTkEntry(master=details_frame, placeholder_text='Enter ID...', textvariable=app.var_ID,
    ...
    Type = CTkComboBox(master=details_frame,
                           ...
                           state='readonly', height=30, width=170, variable=app.var_Type, button_color="#CD7F32",
    ...
    CTkLabel(master=details_frame, text='Title', text_color='#954535', font=('Stack Sans Text', 13, 'bold')).place(
        x=15, y=100)
    Title = CTkEntry(master=details_frame, placeholder_text='Enter Title...', textvariable=app.var_Title,
                     placeholder_text_color='#C19A6B', border_width=2, fg_color='#F3C892',
                     border_color='#834333', font=('Stack Sans Text', 15, 'bold'),
    ...
    Genre = CTkComboBox(master=details_frame,
                           ...
                           state='readonly', height=30, width=170, variable=app.var_Genre, button_color="#CD7F32",
                           fg_color='#F5DEB3', border_color='#834333', border_width=2, button_hover_color="#954535",
                           dropdown_hover_color="#954535", dropdown_fg_color="#CD7F32", dropdown_text_color="#FFFFFF",
                           text_color="#954535", font=('Stack Sans Text', 14), justify='center',
                           dropdown_font=('Stack Sans Text', 14))
    ...
    CTkLabel(master=details_frame, text='IMDb', text_color='#954535', font=('Stack Sans Text', 13, 'bold')).place(
        x=195, y=155)
    IMDb = CTkEntry(master=details_frame, placeholder_text='Enter IMDb...', textvariable=app.var_IMDb,
                    placeholder_text_color='#C19A6B', border_width=2, fg_color='#F3C892',
                    border_color='#834333', font=('Stack Sans Text', 15, 'bold'),
                    corner_radius=10, width=170, height=30, text_color='#834333')
    ...
    Platform = CTkComboBox(master=details_frame,
                           values=["Disney+", "ZEE 5", "VOOT", "Prime Video", "Netflix", "HBO Max", "Sony Liv", "Hulu",
                                   "Youtube", "Hotstar"],
                           state='readonly', height=30, width=170, variable=app.var_Platform, button_color="#CD7F32",
                           fg_color='#F5DEB3', border_color='#834333', border_width=2, button_hover_color="#954535",
                           dropdown_hover_color="#954535", dropdown_fg_color="#CD7F32", dropdown_text_color="#FFFFFF",
                           text_color="#954535", font=('Stack Sans Text', 14), justify='center',
                           dropdown_font=('Stack Sans Text', 14))
    Platform.place(x=190, y=235)
    app.var_Platform.set("Select Platform")

    CTkLabel(master=details_frame, text='Description', text_color='#954535',
             font=('Stack Sans Text', 13, 'bold')).place(
        x=15, y=265)
    Description = CTkEntry(master=details_frame, placeholder_text='Enter Description...',
                           textvariable=app.var_Description,
                           placeholder_text_color='#C19A6B', border_width=2, fg_color='#F3C892',
                           border_color='#834333', font=('Stack Sans Text', 15, 'bold'),
    ...
    CTkLabel(master=details_frame, text='Link', text_color='#954535', font=('Stack Sans Text', 13, 'bold')).place(
        x=15, y=480)
    Link = CTkEntry(master=details_frame, placeholder_text='Enter Link...', textvariable=app.var_Link,
                    placeholder_text_color='#C19A6B', border_width=2, fg_color='#F3C892',
                    border_color='#834333', font=('Stack Sans Text', 15, 'bold'),
                    corner_radius=10, width=350, height=30, text_color='#834333')
    Link.place(x=10, y=505)

    CTkButton(master=details_frame, text='ADD', command=app.AddData, font=('Dela Gothic One', 12),
              fg_color='#954535', hover_color='#7B3F00', cursor='hand2', hover=True, height=30, width=100).place(
        x=25, y=545)

    CTkButton(master=details_frame, text='UPDATE', command=app.UpdateData, font=('Dela Gothic One', 12),
              fg_color='#954535', hover_color='#7B3F00', cursor='hand2', hover=True, height=30, width=100).place(
        x=135, y=545)

    CTkButton(master=details_frame, text='DELETE', command=app.DeleteData, font=('Dela Gothic One', 12),
              fg_color='#954535', hover_color='#7B3F00', cursor='hand2', hover=True, height=30, width=100).place(
        x=245, y=545)
    ...
    CTkComboBox(master=filter_frame, values=["Title", "Genre", "Type", "Certificate", "Platform"],
                state='readonly', height=30, width=200, variable=app.var_SearchBy, button_color="#CD7F32",
                fg_color='#F5DEB3', border_color='#834333', border_width=2, button_hover_color="#954535",
                dropdown_hover_color="#954535", dropdown_fg_color="#CD7F32", dropdown_text_color="#FFFFFF",
    ...
    CTkEntry(master=filter_frame, textvariable=app.var_SearchBox, height=30, width=200,
    ...
    CTkButton(master=filter_frame, text='ADD', command=app.SearchData, font=('Dela Gothic One', 12),
              fg_color='#954535', hover_color='#7B3F00', cursor='hand2', hover=True, height=30, width=100).place(
        x=680, y=10)

    CTkButton(master=filter_frame, text='UPDATE', command=app.ShowAllData, font=('Dela Gothic One', 12),
              fg_color='#954535', hover_color='#7B3F00', cursor='hand2', hover=True, height=30, width=100).place(
        x=790, y=10)

    table_frame = CTkFrame(master=admin_frame, fg_color='#E5AA70', bg_color='#F3C892', width=900, height=530,
                           border_width=2, border_color='#834333')
