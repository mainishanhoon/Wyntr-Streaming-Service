...
def Login_Interface(self):
    CTkLabel(master=self.root, image=CTkImage(light_image=Image.open('assets/images/LogIn.png'), size=(1300, 700)),
             text='').place(x=0, y=0)
    ...
    CTkLabel(master=login_frame, image=CTkImage(light_image=Image.open('assets/images/Logo.jpg'), size=(400, 400)),
             text='').place(x=0, y=0)
