...
from utils import SignOut, AddData, UpdateData, DeleteData, SearchData, ShowData, GetData, StreamNow
...
def User_Interface(self):
    ...
    CTkButton(master=details_frame, text='STREAM NOW', command=lambda: StreamNow(self), font=('Dela Gothic One', 12),
