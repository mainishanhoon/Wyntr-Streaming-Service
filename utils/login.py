...
def Login(self):
    if self.username.get() == '' and self.password.get() == '':
        ...
        CTkMessagebox(master=self.root, title='Wyntr Streaming Service', message='Enter Username.',
                      ...
                      option_1='OKAY', option_focus=1, justify='center', fade_in_duration=1, button_color='#7B3F00',
                      button_hover_color='#9E5D24', border_width=3, border_color='#7B3F00', text_color='#7B3F00',
                      title_color='#7B3F00', icon_size=(40, 40))
        ...
        if self.username.get() == os.getenv('WYNTR_USERNAME') and self.password.get() == os.getenv('WYNTR_PASSWORD'):
            ...
            CTkMessagebox(master=self.root, title='Wyntr Streaming Service',
                          ...
                          option_focus=1, justify='center', fade_in_duration=1, button_color='#7B3F00',
                          button_hover_color='#9E5D24', border_width=3, border_color='#7B3F00',
                          text_color='#7B3F00', title_color='#7B3F00', icon_size=(40, 40))
            UserUI(self)
